                        ...
                        <div class="col-md-4 col-sm-12 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <center><span class="info-box-number" style="font-size: 35px;">{{ $brandCount }}</span></center>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 col-12">
                        ...
                        <div class="col-md-4 col-sm-12 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <center><span class="info-box-number" style="font-size: 35px;">{{ $divisionCount }}</span></center>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4 col-sm-12 col-12">
                            <div class="info-box bg-red">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <center><span class="info-box-number" style="font-size: 35px;">{{ $districtCount }}</span></center>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 col-12">
                            <div class="info-box bg-red">
                                ...
                                <div class="info-box-content">
                                    <center><span class="info-box-text" style="font-size: 18px;">Police Station</span></center>
