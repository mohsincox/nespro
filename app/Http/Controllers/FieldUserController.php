...
class FieldUserController extends Controller
{
    ...
    public function create(Request $request)
    {
    	...
    	return view('field_user.create', compact('phoneNumber', 'agent', 'divisionList', 'districtList', 'policeStationList', 'brandNameList', 'consumerAgeList', 'genderList', 'professionList', 'secList', 'numberList'));
    }
